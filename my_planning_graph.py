...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        current_level  = self.s_levels[level]
        actions = self.all_actions
        self.a_levels.append(set())
        for a in actions:
            a_node = PgNode_a(a)
            if a_node.prenodes.issubset(current_level):
                for c in current_level:
                    c.children.add(a)
                    a_node.parents.add(c)
    ...
    def add_literal_level(self, level):
        ...
        current_level = self.a_levels[level - 1] 
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        negative_cond1 = bool(set(node_a1.action.effect_add) & set(node_a2.action.effect_rem))
        negative_cond2 = bool(set(node_a2.action.effect_add) & set(node_a1.action.effect_rem))

        return negative_cond1 | negative_cond2
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        negative_cond1 = bool(set(node_a1.action.effect_add) & set(node_a2.action.precond_neg) |
            set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos))
        negative_codn2 = bool(set(node_a2.action.effect_add) & set(node_a1.action.precond_neg) |
            set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos))
        return negative_cond1 | negative_codn2
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        negation_match = node_s1.is_pos == node_s2.is_pos
        return symbol_match and not negation_match
